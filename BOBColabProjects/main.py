...
def home():
    ...
    - **MyWorkSpace:** Doucument Management App.
    - **ChequeShield AI:** Automated cheque verification.
    - **StockInsight AI:** Automated Stock Statement Analysis.

    ## How to Use
    Use the dropdown menu beloon the left to navigate to the desired feature. Each feature has a dedicated interface for specific tasks.
